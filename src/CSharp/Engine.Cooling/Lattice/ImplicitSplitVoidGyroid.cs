...
namespace Leap71.Engine.Cooling
{
    ...
    {
        public class ImplicitSplitVoidGyroid : IImplicit
		{
            ...
            /// </summary>
            public ImplicitSplitVoidGyroid(float fUnitSize, float fWallThickness, bool bSide)
			{
			...
			public float fSignedDistance(in Vector3 vecPt)
			{
                ...
                if (m_bSide == true)
                {
                    float fFinalDist = (float)(Math.Max(0, dDist) - 0.5f * m_fWallThickness);
                    return -fFinalDist;
                }
                else
                {
